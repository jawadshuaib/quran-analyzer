...
def _build_user_prompt(payload: dict) -> str:
    ...
    if vtype == "word_origins":
        ...
        body = (
            ...
            "                • Name a familiar phrasing the audience has already heard, then pivot. E.g. 'You’ve heard this verse translated as ‘guarded her chastity’ — the Arabic is doing something far more physical.'\n"
