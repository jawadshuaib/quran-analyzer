...
def _build_user_prompt(payload: dict) -> str:
    ...
    if vtype == "word_origins":
        ...
        body = (
            ...
            "                • PREFERRED — investigative invitation. Name a familiar phrasing the audience has already heard, soften the contrast with hedge language ('appears to', 'seems to be', 'might be'), then INVITE the viewer to look together. E.g. 'You’ve heard this verse translated as guarded her chastity — but the Arabic appears to be doing something far more physical. Let’s take a closer look.' / 'Most English Qur’ans render 25:58 aware of his sins. The Arabic seems to be saying something stranger. Let’s look.' This register reads as curious co-investigation rather than correction, which is the tone the channel wants.\n"
